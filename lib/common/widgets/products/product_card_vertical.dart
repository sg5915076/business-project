...
import 'package:business_project/features/shop/screens/product_details/product_details.dart';
            ...
            RoundedContainer(
              ...
              child: Stack(
                children: [
                  ...
                  const Positioned(top: 0, right: 0, child: CircularIcon(width: 40, height: 40, icon: Iconsax.heart5, color: Colors.red,))
                ],
              ),
            ),
